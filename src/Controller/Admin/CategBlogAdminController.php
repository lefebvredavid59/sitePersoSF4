...
class CategBlogAdminController extends AbstractController
{
    ...
    {
        return $this->render('admin/categ_blog_admin/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('admin/categ_blog_admin/new.html.twig', [
    ...
    {
        return $this->render('admin/categ_blog_admin/show.html.twig', [
            'categ_blog' => $categBlog,
        ]);
    }
    ...
    public function edit(Request $request, CategBlog $categBlog, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('admin/categ_blog_admin/edit.html.twig', [
            'categ_blog' => $categBlog,
            'form' => $form->createView(),
        ]);
    }
